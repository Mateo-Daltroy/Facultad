...
public class JobSchedulerTest {
    ...
    private JobScheduler newFifoScheduler() {
        ...
        fifoScheduler.setStrategy(new GestorTrabajosFIFO());
    ...
    private JobScheduler newLifoScheduler() {
        ...
        lifoScheduler.setStrategy(new GestorTrabajosLIFO());
    ...
    private JobScheduler newPriorityScheduler() {
        ...
        priorityScheduler.setStrategy(new GestorTrabajosPriority());
    ...
    private JobScheduler newEffortScheduler() {
        ...
        effortScheduler.setStrategy(new GestorTrabajosEffort());
